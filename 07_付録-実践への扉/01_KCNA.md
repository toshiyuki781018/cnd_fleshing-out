...
### ２：Kubernetes とコンテナオーケストレーション（分散を、管理可能にする。）
...
### ３：クラウドネイティブアーキテクチャ（変化を前提に、設計する。）
...
### ４：Observability【可観測性】（見えないものを、見る技術。）
